...
**Warning!**
We strongly recommend not changing this option unless reproducibility with
previous versions is desired.
...
case, we allow the user to skip this procedure and provide their own estimate
