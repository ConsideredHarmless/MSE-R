...
#' \mjsdeqn{y = \mathbb{1}\left\lbrace \tilde{\beta}^T x + u \geq 0 \right\rbrace}, where
#' \mjseqn{\mathbb{1}\left\lbrace\cdot\right\rbrace} is the indicator function/Iverson bracket,
...
#'
#' Let us partition \mjseqn{x = (x_1, x_r)}, where the two parts have length
#' \mjseqn{1} (a scalar) and \mjseqn{d} respectively. The authors further
#' assume that the distibution of \mjseqn{x_1} conditional to \mjseqn{x_r} is
...
#' is
#' \mjsdeqn{
#'      F_{u | x}(u | x) = F_{u | x_1, x_r}(u | x_1, x_r) =
